...
plot_main_title <- paste("##", siteNumber, lake_nm) # the `#` make it larger/bold
...
```{r eval=isData, echo=FALSE, warning=FALSE, message=FALSE, results = 'asis'}
