...
plot_p <- makeTimeseriesPlot(totalP, totalP_title, date_info, ylim_buffer = 0.05, plot_main_title = plot_main_title, plot_sub_title = plot_sub_title, top_margin = 8)
...
plot_tsi <- makeTimeseriesPlot(trophic, trophic_title, date_info, isTrophicIndex = TRUE,
                               addLegend = plot_secchi$legend, bottom_margin = 8)
