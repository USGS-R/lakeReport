...
layout(plot_layout)
makeTimeseriesPlot(totalP, totalP_title, date_info, ylim_buffer = 0.05)
makeTimeseriesPlot(chlorophyll, chlorophyll_title, date_info, ylim_buffer = 0.05)
makeTimeseriesPlot(secchi, secchi_title, date_info,
                   axisFlip = TRUE, ylim_buffer = 0.05)
makeTimeseriesPlot(trophic, trophic_title, date_info, isTrophicIndex = TRUE)
```
