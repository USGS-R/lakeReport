...
layout(plot_layout)
makeTimeseriesPlot(totalP, totalP_title, isTrophicIndex = FALSE, 
                   axisFlip = FALSE, date_info = date_info, ylim_buffer = 0.05)
makeTimeseriesPlot(chlorophyll, chlorophyll_title, isTrophicIndex = FALSE, 
                   axisFlip = FALSE, date_info = date_info, ylim_buffer = 1)
makeTimeseriesPlot(secchi, secchi_title, isTrophicIndex = FALSE, 
                   axisFlip = TRUE, date_info = date_info, ylim_buffer = 0.5)
makeTimeseriesPlot(trophic, trophic_title, isTrophicIndex = TRUE, 
                   axisFlip = FALSE, date_info = date_info)
```
