...
plot_p <- makeTimeseriesPlot(totalP, totalP_title, date_info, ylim_buffer = 0.05, plot_main_title = plot_main_title, plot_sub_title = plot_sub_title)
